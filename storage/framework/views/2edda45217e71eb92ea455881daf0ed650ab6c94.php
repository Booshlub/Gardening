...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/blog-post.css')); ?>">
	<link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/bootstrap.css')); ?>">
	<link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/metisMenu.css')); ?>">
	<link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/sb-admin-2.css')); ?>">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a href="<?php echo e(route('comments.index')); ?>">All Comments</a>
                            </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                             <li>
								 <a href="<?php echo e(route('media.index')); ?>">All Media</a>
                            </li>
 
                            <li>
								<a href="<?php echo e(route('media.create')); ?>">Upload Media</a>
                            </li>
