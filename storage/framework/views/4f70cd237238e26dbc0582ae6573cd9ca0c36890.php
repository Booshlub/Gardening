...
<div class="container">
    ...
    <div class="row dropzone">
         <?php echo Form::open(['method'=>'POST', 'enctype'=>"multipart/form-data", 'class'=>'dropzone', 'id'=>'mydropzone', 'action'=> 'AdminPostsController@store', 'files'=>true]); ?>
	...
	<tr>
		...
		<td><?php echo e($post->created_at->diffForHumans()); ?></td>
							...
							<?php echo e($post->comments[0]->body); ?>
