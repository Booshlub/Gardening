...
<head>
	...
	<link rel="stylesheet" type="text/css" href="{{asset('css/styles/blog-post.css')}}">
	<link rel="stylesheet" type="text/css" href="{{asset('css/styles/bootstrap.css')}}">
	<link rel="stylesheet" type="text/css" href="{{asset('css/styles/font-awesome.css')}}">
	<link rel="stylesheet" type="text/css" href="{{asset('css/styles/metisMenu.css')}}">
	<link rel="stylesheet" type="text/css" href="{{asset('css/styles/sb-admin-2.css')}}">
